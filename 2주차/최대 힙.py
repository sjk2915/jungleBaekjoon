...
class MaxHeap():
    ...
    def _heapify_down(self):
        ...
        while self._has_left_child(current_index):
            bigger_child_index = self._get_left_child_index(current_index)
            ...
            if self._has_right_child(current_index) and \
               self._get_right_child(current_index) > self._get_left_child(current_index):
                bigger_child_index = self._get_right_child_index(current_index)
            ...
            if self.heap[current_index] >= self.heap[bigger_child_index]:
                ...
                current_index = bigger_child_index # 현재 인덱스를 더 큰 자식 인덱스로 업데이트
